...
public class Agregar extends javax.swing.JFrame {
  ...
  this.setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        jTextPlato = new javax.swing.JTextField();
        ...
        jTextPlato.setBackground(new java.awt.Color(204, 204, 255));
        jTextPlato.setFont(new java.awt.Font("Loma", 1, 12)); // NOI18N
        jTextPlato.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jTextPlato.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextPlatoActionPerformed(evt);
            }
        });
    ...
    private void jTextPlatoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextPlatoActionPerformed
        
    }//GEN-LAST:event_jTextPlatoActionPerformed
...
try{
Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/platillos","root","");
PreparedStatement pst = cn.prepareStatement("insert into jTable1(Ingredientes, Cantidad) values(?,?)");

pst.setString(1, "Ingredientes");
...
pst.setInt(2, 0);
    ...
    private javax.swing.JTextField jTextPlato;
